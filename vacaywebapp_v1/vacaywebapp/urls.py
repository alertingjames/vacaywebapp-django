...
urlpatterns = [
    ...
    url(r'^to_update_profile', views.to_update_profile, name='to_update_profile'),
    url(r'^tomap/$', views.tomap, name='tomap'),
    url(r'^getloc/$', views.getloc, name='getloc'),
    url(r'^user_post_profile', views.user_post_profile, name='user_post_profile'),
    ...
    url(r'^friendprofile/(?P<mail_id>[0-9]+)/$', views.friendprofile, name='friendprofile'),
    url(r'^profile/(?P<info_id>[0-9]+)/$', views.profile, name='profile'),
    ...
    url(r'^deletemail/(?P<mail_id>[0-9]+)/$', views.deletemail, name='deletemail'),
    url(r'^deletebox/(?P<mail_id>[0-9]+)/$', views.deletebox, name='deletebox'),
