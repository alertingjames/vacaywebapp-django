...
class Friend(models.Model):
    ...
    age = models.CharField(max_length=5)
    gender = models.CharField(max_length=10)
    datingpref = models.CharField(max_length=10)
    address = models.CharField(max_length=200)
    job = models.CharField(max_length=300)
    education = models.CharField(max_length=200)
    interests = models.CharField(max_length=2000)
    ...
    card_cvc = models.CharField(max_length=10)
    card_expmonth = models.CharField(max_length=5)
    card_expyear = models.CharField(max_length=5)
    video = models.CharField(max_length=500)
